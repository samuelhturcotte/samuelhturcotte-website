    ...
    return (
        <div className="container-less-waste">
            ...
            <div className="case-study-container">
                ...
                <img className="less-waste-case-study-img" src={require("../../../assets/images/less-waste-img/intropicture.png")} alt="recall" />
            ...
            <h4>We were a four-member team:</h4>
            ...
            <img className="less-waste-process-picture" src={require("../../../assets/images/less-waste-img/processpicture.png")} alt="recall" />
            ...
            <ul className="less-waste-point-container">
                <li className="less-waste-point"><span className="bold-less-waste-point">131</span> pounds of spoiled food are thrown away by Americans each year.</li>
                <li className="less-waste-point"><span className="bold-less-waste-point">52%</span> of people said a top reason for throwing out food was because it spoiled before
                 they had a chance to eat it.</li>
                <li className="less-waste-point"><span className="bold-less-waste-point">77%</span> of people say they overpay for a subscription they no longer use.</li>
            </ul>
            ...
            <img className="less-waste-demographic-picture" src={require("../../../assets/images/less-waste-img/demographics.jpeg")} alt="recall" />
            ...
            <img className="ideation-picture" src={require("../../../assets/images/less-waste-img/ideationquestionaire.png")} alt="recall" />
            ...
            <h4 className="section-medium-title">Here's an example of what some interviewees had to say:</h4>
            ...
            <h4 className="section-medium-title">Through a survey sent out, we found that:</h4>
            ...
            <img className="persona-img" src={require("../../../assets/images/less-waste-img/john-persona.png")} alt="recall" />
            ...
            <img className="hmw-img" src={require("../../../assets/images/less-waste-img/hmw-iterations.png")} alt="recall" />
            ...
            <h4 className="section-medium-title">Reduce food waste through:</h4>
            ...
            <img className="demographic-picture" src={require("../../../assets/images/less-waste-img/inspiration-vision-board.png")} alt="recall" />
            ...
            <div className="screen-sketches-container">
                ...
                <img className="screen-sketches-img" src={require("../../../assets/images/less-waste-img/explorationpicture1.png")} alt="recall" />
            </div>
            ...
            <img className="screen-sketches-img" src={require("../../../assets/images/less-waste-img/screens-option.png")} alt="recall" />
            ...
            <h4 className="section-medium-title">Positives</h4>
            ...
            <h4 className="section-medium-title">Findings + Suggestions</h4>
            ...
            <img className="demographic-picture" src={require("../../../assets/images/less-waste-img/journeymap.png")} alt="recall" />

            <h3 className="section-big-title">User Flow</h3>
            <p className="less-waste-text">We have created a journey map representing how our solution would reduce food waste and benefit people financially.
            </p>
            <img className="demographic-picture" src={require("../../../assets/images/less-waste-img/userflow-img.png")} alt="recall" />
